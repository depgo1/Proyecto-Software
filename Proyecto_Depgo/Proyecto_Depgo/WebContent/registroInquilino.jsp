...
<table width="565" border="0" align="center" background="img/fondo1.jpg" >
  <tr>
    <td width="451" align="center"><!-- InstanceBeginEditable name="EditRegion1" -->
      ...
      <table width="471" height="297" border="0" >
        <tr>
        ...
        <tr>
          <td width="285" rowspan="3"  align="center" valign="middle"><img src="img/edificio.jpg" width="284" height="199" /></td>
          <td width="133" height="53">&nbsp;</td>
        </tr>
        <tr>
          <td valign="top">Estoy en registro inquilino</td>
        </tr>
        <tr>
          <td valign="bottom">&nbsp;</td>
        </tr>
